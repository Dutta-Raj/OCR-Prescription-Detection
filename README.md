...
🧠 Custom CNN + LSTM + BiLSTM model for text recognition

🖨️ Optional Tesseract or TrOCR comparison

🧩 OpenCV preprocessing for noise reduction and thresholding

🌐 Simple Flask web interface for easy testing
