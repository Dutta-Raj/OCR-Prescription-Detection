...
└── LICENSE
🧠 Methodology
1. Preprocessing - PDF to image, grayscale, adaptive thresholding, resizing (128x32), normalization, skew correction, noise removal, CLAHE, data augmentation

2. Model - CNN encoder extracts features → BiLSTM decoder processes sequences → Attention mechanism focuses on characters

3. Post-processing - Spell checking, regex filtering (dates, drug names), fuzzy matching for typos
